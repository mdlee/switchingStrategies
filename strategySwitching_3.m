...
% v3 introduces latent mixture

% to do
% run data for existing ssLM_TTBTallyWADDGuess: rieskampotto data, newell
% shanks, lee et al
% write versions for ss_GuessTTBTallyWADDWADDprobSaturated and ss_TTBEQWTTBWADDGuess
